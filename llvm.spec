...
%changelog
* ${CHANGELOG_DATE} Konrad Kleine - ${LLVM_VERSION_MAJOR}.${LLVM_VERSION_MINOR}.${LLVM_VERSION_PATCH}-0.${BASERELEASE}.${SNAPSHOT_NAME}
- Daily build of ${LLVM_VERSION_MAJOR}.${LLVM_VERSION_MINOR}.${LLVM_VERSION_PATCH}-0.${BASERELEASE}.${SNAPSHOT_NAME}
